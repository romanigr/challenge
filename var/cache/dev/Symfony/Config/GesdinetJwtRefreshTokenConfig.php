...
class GesdinetJwtRefreshTokenConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
     ...
     * @psalm-return (TValue is array ? \Symfony\Config\GesdinetJwtRefreshToken\CookieConfig : static)
     */
    public function cookie(array $value = []): \Symfony\Config\GesdinetJwtRefreshToken\CookieConfig|static
    {
        if (!\is_array($value)) {
