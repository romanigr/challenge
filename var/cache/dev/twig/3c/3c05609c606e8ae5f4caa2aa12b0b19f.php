...
class __TwigTemplate_321e8a748d028bba9abeb202e801b313 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 49
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 49, $this->source); })()), "getDumps", [0 => "html"], "method", false, false, false, 49));
