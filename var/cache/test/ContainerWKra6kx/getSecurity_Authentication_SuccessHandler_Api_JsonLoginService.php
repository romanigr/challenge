 ...
 */
class getSecurity_Authentication_SuccessHandler_Api_JsonLoginService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.authentication.success_handler.api.json_login'])) {
            return $container->privates['security.authentication.success_handler.api.json_login'];
        }
        ...
        return $container->privates['security.authentication.success_handler.api.json_login'] = new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler(new \Lexik\Bundle\JWTAuthenticationBundle\Security\Http\Authentication\AuthenticationSuccessHandler($a, $b, [], true), [], 'api');
    }
}
