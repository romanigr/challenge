 ...
 */
class getGesdinet_Jwtrefreshtoken_Request_Extractor_ChainService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addExtractor(($container->privates['gesdinet.jwtrefreshtoken.request.extractor.request_body'] ??= new \Gesdinet\JWTRefreshTokenBundle\Request\Extractor\RequestBodyExtractor()));
        $instance->addExtractor(($container->privates['gesdinet.jwtrefreshtoken.request.extractor.request_parameter'] ??= new \Gesdinet\JWTRefreshTokenBundle\Request\Extractor\RequestParameterExtractor()));
        $instance->addExtractor(($container->privates['gesdinet.jwtrefreshtoken.request.extractor.request_cookie'] ??= new \Gesdinet\JWTRefreshTokenBundle\Request\Extractor\RequestCookieExtractor()));
